...
LIST player_knows = (nada), junia_shadowy, entropic_goliath, goliath_hands_in_pie, no_nth_exit, junia_dealing_w_goliath, be_zero_investor, goliath_accounts, nth_in_bern, bentons_master_plan, junia_wants_b_dead, j_betray_proof
