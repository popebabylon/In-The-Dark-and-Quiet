...

{
    ...
    - status == (Pluto_Flyby) && not team_04_flyby && tarc_04 && woodpecker_04 && junia_04_lastchance:
...

{
    ...
    - status == (Pluto_Flyby) && not benton_09 && team_04:
    
        ~ benton_button = "<div class='menu active'><i class='material-icons md-18'>person</i><span>Benton</span></div>"
    
        ~ benton_chat_divert = benton_climax_spot
        
    - status == (Pluto_Flyby) && not benton_09_keepittogether && lucas_04:
...

{
    ...
    - status == (Pluto_Flyby) && not junia_04 && lucas_04 && benton_09_keepittogether:
        ~ junia_button = "<div class='menu active'><i class='material-icons md-18'>person</i><span>Junia</span></div>"
    
        ~ junia_chat_divert = junia_climax_spot
        
    - status == (Pluto_Flyby) && not junia_04_lastchance && woodpecker_04 && tarc_04:
        ~ junia_button = "<div class='menu active'><i class='material-icons md-18'>person</i><span>Junia</span></div>"
...
- status == (Jupiter_Flyby) && not lucas_02.lucas_analysis && lucas_02.lucas_angryout: 
    ...
    - status == (Pluto_Flyby) && not lucas_04 && team_04 && benton_09: 
